...
namespace WebApp.Application.Implementation
{
    public class ProductCategoryService : IProductCategoryService
    {
        ...
        {
            return _productCategoryRepository.FindAll().OrderBy(c => c.ParentId).ProjectTo<ProductCategoryViewModel>().ToList();
        }
        ...
        public List<ProductCategoryViewModel> GetAll(string keyword)
        {
            ...
            else return _productCategoryRepository.FindAll()
                .OrderBy(x => x.ParentId).ProjectTo<ProductCategoryViewModel>()
                .ToList();
        }
